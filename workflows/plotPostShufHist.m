...
cd('/Users/manishm/Dropbox (Dartmouth College)/GLMTemp/PosTrial')
...
% text(0.000005,100,strcat('Percentage of improved models :',{' '}, num2str(round(pc,2))),'fontsize',12);
% hold off;
% figure;
% mask = c_0 > 0;
% bin_edges = -0.000005:0.0000005:0.00001;
...
%% For bphi
c_all = mod_pred.bphi(:,3:12);
c_all = c_all(:);
c0 = mod_pred.bphi(:,2) == 0;
c_0 = mod_pred.bphi(c0,3:12);
c_0 = c_0(:);
c1 = mod_pred.bphi(:,2) == 1;
c_1 = mod_pred.bphi(c1,3:12);
c_1 = c_1(:);
c2 = mod_pred.bphi(:,2) == 2;
c_2 = mod_pred.bphi(c2,3:12);
c_2 = c_2(:);
c_12 = [c_1;c_2];
% figure;
% mask = c_all > 0;
...
%% For lgphi
c_all = mod_pred.lgphi(:,3:12);
c_all = c_all(:);
c0 = mod_pred.lgphi(:,2) == 0;
c_0 = mod_pred.lgphi(c0,3:12);
c_0 = c_0(:);
c1 = mod_pred.lgphi(:,2) == 1;
c_1 = mod_pred.lgphi(c1,3:12);
c_1 = c_1(:);
c2 = mod_pred.lgphi(:,2) == 2;
c_2 = mod_pred.lgphi(c2,3:12);
c_2 = c_2(:);
c_12 = [c_1;c_2];
% figure;
% mask = c_all > 0;
