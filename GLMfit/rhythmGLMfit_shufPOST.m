function sd = rhythmGLMfit_shufPOST(cfg_in)
...
timeSkip = csc.tvec(timeSkipIdx(end)); %the last "big" jump
...
% Changing Timebase to include only postbehabiour resting period
TVECe = max(timeSkip,ExpKeys.TimeOffTrack+10):cfg_master.dt:csc.tvec(end);
